...
You can use chat-ui with Vercel AI RSC easily with the following steps:

First, define AIProvider with chat server action:
...
Second, define useChatRSC hook in the frontend with append function and necessary states:
...
Then, create ChatSection by using @llamaindex/chat-ui:
...
Put ChatSection under AIProvider in the parent component (or in root layout):
