...
The TypeScript implementation is designed for JavaScript server side applications like

<SiNodedotjs className="inline" color="#5FA04E" /> Node.js,
<SiDeno className="inline" color="#70FFAF" /> Deno,
<SiBun className="inline" /> Bun,
