...
To create documents from the text nodes of the json object, we just map the needed vaues to a new `Document` object.
...
For this we need to pass create `ImageNodes` and add them as part of our message.
