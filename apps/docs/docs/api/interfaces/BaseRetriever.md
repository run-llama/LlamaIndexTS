...
[Retriever.ts:10](https://github.com/run-llama/LlamaIndexTS/blob/3fda1de/packages/core/src/Retriever.ts#L10)
...
[Retriever.ts:9](https://github.com/run-llama/LlamaIndexTS/blob/3fda1de/packages/core/src/Retriever.ts#L9)
