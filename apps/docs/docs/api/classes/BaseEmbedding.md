...
[Embedding.ts:206](https://github.com/run-llama/LlamaIndexTS/blob/9fa6d4a/packages/core/src/Embedding.ts#L206)
...
[Embedding.ts:205](https://github.com/run-llama/LlamaIndexTS/blob/9fa6d4a/packages/core/src/Embedding.ts#L205)
