export const getDefaultSingleSelectPrompt = (
  numChoices: number,
  contextList: string,
  queryStr: string,
): string => {
  return `Some choices are given below. It is provided in a numbered list (1 to ${numChoices}),
...
export const getDefaultMultiSelectPrompt = (
  numChoices: number,
  contextList: string,
  queryStr: string,
  maxOutputs: number,
